...
const Footer = () => {
  ...
  return (
    <footer className="w-full mt-[5vh] overflow-x-hidden font-poppins">
      <div className="w-full px-[2vw] md:px-[4vw] lg:px-[6vw] pt-[1vh] pb-[2vh]">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-y-[4vh] gap-x-[4vw] w-full">
          ...
          <div className="flex flex-col items-center text-center lg:items-start lg:text-left ">
            ...
            <p className="text-[#5C2C06] text-xs md:text-sm leading-relaxed max-w-[30vw] mt-[1vh]">
              {t.about}
            </p>
          </div>
      ...
      {/* Bottom Strip */}
      <div className="w-full border-t border-[#A66A3C] ">
        <div className="flex flex-col sm:flex-row justify-between items-center px-[2vw] md:px-[4vw] lg:px-[6vw] py-[2vh] text-center sm:text-left space-y-[1vh] sm:space-y-0">
          <p className="text-[#5C2C06] font-semibold text-xs sm:text-sm">{t.copyright}</p>
          <div
            className="flex items-center justify-center space-x-2 px-4 py-2 rounded-full bg-[#F5F2E7] border border-[#A66A3C] shadow-sm hover:shadow-md transition-all duration-300 cursor-pointer"
            onClick={() => window.open('https://zerlak.com/', '_blank')}
          >
            <span className="text-[#5C2C06] font-semibold text-sm">{t.designed}</span>
            <span className="text-[#D89F3F] text-sm font-bold hover:scale-110 transition-transform duration-300">
              Zerlak
            </span>
          </div>
        </div>
